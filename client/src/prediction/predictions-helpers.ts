import { GraphUnit, PredictionResponseUnit, MonthlySalesResponseUnit } from "./prediction-types";
...
export function ConvertMonthlySalesForGraphs(predictions: MonthlySalesResponseUnit[]) {
    const result: GraphUnit[] = [];
