            ...
            analytics && 
                <div className="flex justify-center">
                    <div className="flex flex-col gap-2">
                        <div className="flex flex-col gap-2">
                            <div className="text-center text-xl">Щомісячна сума продажів:</div>
                        ...
                        <div className="flex flex-col gap-2">
                            <div className="text-center text-xl">Середня сума чеку за місяць:</div>
                        ...
                        <div className="flex flex-col gap-2">
                            <div className="text-center text-xl">Кількість транзакцій за місяць</div>
