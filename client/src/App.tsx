  ...
  return (
      <BrowserRouter>
        <header className='flex flex-row px-4 py-2 gap-4 justify-center'>
          <Link to="products" className={linkStyle}>ТОВАРИ</Link>
          <Link to="transactions" className={linkStyle}>ТРАНЗАКЦІЇ</Link>
          <Link to="prediction" className={linkStyle}>АНАЛІЗ ПРОДАЖУ</Link>
          <Link to="analytics" className={linkStyle}>АНАЛІТИКА</Link>
          <Link to="pairs" className={linkStyle}>ШАБЛОНІ ПОКУПКИ</Link>
          <Link to="/" className={linkStyle}>ОБЛІКОВИЙ ЗАПИС</Link>
        </header>
        <Routes>
